...
// customerFields = [
//   { name: 'name', label: 'اسم العميل', type: 'text', placeholder: 'ادخل الاسم', required: true },
//   { name: 'phone', label: 'رقم الهاتف', type: 'number', placeholder: '+966...', required: true },
//   { name: 'email', label: 'البريد الإلكتروني', type: 'email', required: true },
//   { name: 'joinDate', label: 'تاريخ الانضمام', type: 'date' },
...
//     { name: 'supplierName', label: 'اسم الشريك', type: 'text', required: true, placeholder: 'ادخل اسم الشريك' },
...
//     console.log('🚀 بيانات الشريك:', data);
//     this.closeModal(); // يقفل المودال بعد الحفظ
//   }
